...
export const addIngredient = createAsyncThunk('/adminStorage/addIngredient', async (formData) => {
...
export const getIngredient = createAsyncThunk('/adminStorage/getIngredient', async (id) => {
...
export const getAllIngredients = createAsyncThunk('/adminStorage/getAllIngredients', async () => {
    const response = await axios.get(
...
export const updateIngredient = createAsyncThunk('/adminStorage/updateIngredient', async ({ id, formData }) => {
...
export const deleteIngredient = createAsyncThunk('/adminStorage/deleteIngredient', async (id) => {
