...
import { addIngredient, deleteIngredient, fetchAllIngredient, getIngredient, updateIngredient } from '../../controllers/admin/ingredientController.js'
...
router.get('/all', staffAuthMiddleware, requireRoleMiddleware('staff', 'admin'), fetchAllIngredient)
